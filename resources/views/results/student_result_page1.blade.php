                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-sm">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><strong>GPA(First):</strong></td>
                                                        <td>{{ $student['totalGPA'] ?? 'N/A' }}</td>
                                                        <td><strong></strong></td>
                                                        <td rowspan="2"><img src="{{asset('signature/' . $hod->sign)}}" alt="Hod Signature" width="160" height="60"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>GPA(Second):</strong></td>
                                                        <td>{{ $student['totalGPA2'] ?? 'N/A' }}</td>
                                                        <td>&nbsp;</td>
                                                    </tr>                                
                                                    <tr>
                                                        <td><strong>CGPA:</strong></td>
                                                        <td>{{ $student['totalCGPA'] ?? 'N/A' }}</td>
                                                        <td>&nbsp;</td>
                                                        <td>{{$hod->hod_name}}</td>
                                                    </tr>
