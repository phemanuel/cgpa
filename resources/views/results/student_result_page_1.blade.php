                                            ...
                                            <table class="table table-bordered table-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td rowspan="3">
                                                            <img src="{{ asset('signature/' . $hod->sign) }}" alt="HOD Signature" width="160" height="60">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 13px;">
                                                            <span class="{{ $studentData['remarks'] === 'PASSED ALL' ? 'text-success' : 'text-danger' }}">
                                                                {{ $studentData['remarks'] }}
                                                            </span>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3" style="font-size: 12px;">{{ $studentData['failedRemarks'] }}</td>
                                                    </tr>
                                                    @endif
                                                </tbody>
                                            </table>
