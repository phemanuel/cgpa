                                        ...
                                        <table class="table table-bordered table-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center; font-size: 13px;">{{$studentData['total_grade_point_new']}}</td>                                                        
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center; font-size: 13px;">{{$studentData['total_course_unit_new']}}</td>                                                                                                                
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 13px;"><strong>CGPA(300):</strong></td>
                                                        <td style="font-size: 13px;">{{ $studentData['totalCGPA'] ?? 'N/A' }}</td>
                                                        <td>&nbsp;</td>
                                                        <td style="text-align: center; font-size: 13px;">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 13px;"><strong>CGPA(200):</strong></td>
                                                        <td style="font-size: 13px;">{{ $studentData['cgpa2'] ?? 'N/A' }}</td>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 13px;"><strong>CGPA(100):</strong></td>
                                                        <td style="font-size: 13px;">{{ $studentData['cgpa1'] ?? 'N/A' }}</td>
                                                        <td>&nbsp;</td>
                                                  </tr>
                                                    <tr>
                                                        <td style="font-size: 13px;"><strong>FINAL-CGPA:</strong></td>
                                                        <td style="font-size: 13px;"><strong>{{ $studentData['totalCGPANEW'] ?? 'N/A' }}</strong> </td>
                                                        <td>&nbsp;</td>
