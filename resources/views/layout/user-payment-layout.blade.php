              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  @elseif(session('error'))
                    ...
                    @endif	
                  <div class="card-body">
                    <form action="https://flickspay.flickstechnologies.com/flk/collections/pay" method="post">
                      @csrf
                    ...
                    <div class="form-group">
                      <label>Amount</label>
                      @foreach($transcriptFee as $transcriptFees)
                      <p>=N= {{ number_format($transcriptFees->fee_amount,2) }}</p>
                      @endforeach
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <p>=N= {{ number_format($pay_amount,2) }}</p>
                    </div>                    
                  </div>
                  <div class="card-footer text-right">   
                  <input name="merchant_id" type="hidden" value="{{$merchant_id}}" />
    <input name="product_id" type="hidden" value="{{$product_id}}" />
    <input name="product_description" type="hidden" value="{{$product_description}}" />
    <input name="amount" type="hidden" value="{{$amount}}" />
    <input name="currency" type="hidden" value="{{$currency}}" />
    <input name="transaction_id" type="hidden" value="{{$transactionId}}" />
    <input name="response_url" type="hidden" value="{{$response_url}}">
    <input name="email" type="hidden" value="{{auth()->user()->email}}" />
    <input name="customer_id" type="hidden" value="{{$matric_no}}" />
    <input name="phone_no" type="hidden" value="{{$phone_no}}" />
    <input name="name" type="hidden" value="{{$name}}">
    <input name="payment_params" type="hidden" value='{{$payment_params}}' />
    <input name="hash" type="hidden" value="{{$hashed_string}}" />                 
                    <input class="btn btn-primary mr-1" type="submit" value="Pay now"></input>
                  </div>
                    </form>
