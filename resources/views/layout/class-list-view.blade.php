                ...
                <div class="card l-bg-green">
                  <div class="card-statistic-3">
                    ...
                    <div class="card-content">
                      <h4 class="card-title">Student - {{$allStudent->count()}}</h4>
                      <span><strong></strong></span>
                      <div class="progress mt-1 mb-1" data-height="8">
                        <div class="progress-bar l-bg-purple" role="progressbar" data-width="{{$allStudent->count()}}" aria-valuenow="{{$allStudent->count()}}"
                          aria-valuemin="0" aria-valuemax="{{$allStudent->count()}}"></div>
                      </div>
...
<div id="allStudentsTable" style="display: none;">
    <h4>{{$programme}} {{$studentLevel}} Level Class List for {{$admissionYear}} Admission Year</h4>
