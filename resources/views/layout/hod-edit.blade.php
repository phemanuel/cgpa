              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Edit HOD | <a href="{{route('hod-setup')}}">HOD List</a></h4>
                  </div>
                  @if(session('success'))
                  ...
                  @elseif(session('error'))
                    ...
                    @endif	
                  <div class="card-body">
                <form action="{{route('hod-edit.action', ['id' => $hod->id])}}" method="post" enctype="multipart/form-data">
                      @csrf   
                      @method('PUT')                 
                <div class="form-group">
                    <label>Department</label>
                    <select name="department" id="" class="form-control" required>                        
                            <option value="{{$hod->dept}}">{{$hod->dept}}</option>                        
                    </select>
                </div>
                @error('department')
                ...
                <div class="form-group">
                    ...
                    <select name="programme" id="" class="form-control" required>                        
                            <option value="{{$hod->course}}">{{$hod->course}}</option>                       
                    </select>
                </div>
                @error('department')
                    <span class="invalid-feedback">{{ $message }}</span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fullName" value="{{ old('fullName', $hod->hod_name) }}" required>
                </div>
                @error('fullName')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
                ...
                <p><img src="{{asset('signature/'. $hod->sign)}}" alt="" width="200" height="200"></p>
                @error('signature')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
                  ...
                  <div class="card-footer text-right"> 
                    <input class="btn btn-primary mr-1" type="submit" value="Update"></input>
