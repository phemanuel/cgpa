            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                  <div class="card-body">
  <a href="{{route('student-registration')}}" class="btn btn-success" style="color: white;" data-toggle="tooltip" data-placement="top" title="Register students.">
    <i class="fas fa-user-plus"></i> Student Registration
  </a>
  <a href="{{route('student-migration')}}" class="btn btn-info" style="color: white;" data-toggle="tooltip" data-placement="top" title="Migrate students to the next academic level.">
    <i class="fas fa-arrow-up"></i> Student Migration
  </a>
</div>
