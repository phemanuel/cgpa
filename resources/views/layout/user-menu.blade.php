            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                  <div class="card-body">
                    <a href="{{ route('users') }}" class="btn btn-primary" style="color: white;" data-toggle="tooltip" data-placement="top" title="Manage admin users.">
                        <i class="fas fa-users-cog"></i> Admins
                    </a>
                    <a href="{{ route('instructors') }}" class="btn btn-warning" style="color: white;" data-toggle="tooltip" data-placement="top" title="Manage instructor accounts.">
                        <i class="fas fa-chalkboard-teacher"></i> Instructors
                    </a>
                    <a href="{{ route('student') }}" class="btn btn-secondary" style="color: white;" data-toggle="tooltip" data-placement="top" title="View and manage student accounts.">
