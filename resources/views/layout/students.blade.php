                ...
                <div class="card l-bg-green">
                  <div class="card-statistic-3">
                    ...
                    <div class="card-content">
                      <h4 class="card-title">Students - {{$userCount}}</h4>
                      <span><strong></strong></span>
                      <div class="progress mt-1 mb-1" data-height="8">
                        <div class="progress-bar l-bg-purple" role="progressbar" data-width="{{$userCount}}" aria-valuenow="{{$userCount}}"
                          aria-valuemin="0" aria-valuemax="{{$userCount}}"></div>
                      </div>
