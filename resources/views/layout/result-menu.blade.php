            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                  <div class="card-body">
                    <a href="{{ route('result-entry') }}" class="btn btn-primary" style="color: white;" data-toggle="tooltip" data-placement="top" title="Enter results for students.">
                        <i class="fas fa-keyboard"></i> Result Entry
                    </a>
                    <a href="{{ route('result-compute') }}" class="btn btn-warning" style="color: white;" data-toggle="tooltip" data-placement="top" title="Compute student results.">
                        <i class="fas fa-calculator"></i> Result Computation
                    </a>
                    <a href="{{ route('semester-result') }}" class="btn btn-secondary" style="color: white;" data-toggle="tooltip" data-placement="top" title="View semester results.">
                        <i class="fas fa-file-alt"></i> Semester Result
                    </a>
                    <hr>
                    <a href="{{ route('semester-summary') }}" class="btn btn-success" style="color: white;" data-toggle="tooltip" data-placement="top" title="View summary of semester results.">
                        <i class="fas fa-chart-bar"></i> Semester Result Summary
                    </a>
                    <a href="{{ route('cgpa-summary') }}" class="btn btn-info" style="color: white;" data-toggle="tooltip" data-placement="top" title="View CGPA summary.">
                        <i class="fas fa-graduation-cap"></i> CGPA Summary
                    </a>
                    </div>
