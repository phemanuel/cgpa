                      ...
                      <tbody>
                          @if ($users->count() > 0)
                              ...
                              <tr> 
                                  ...
                                  <img 
                                    alt="Profile Picture" 
                                    src="{{ file_exists(public_path('profile_pictures/' . $user->image)) ? asset('profile_pictures/' . $user->image) : asset('uploads/blank.jpg') }}" 
                                  ...
                                  <td>
                                    <a href="{{ route('edit-instructor', ['id' => $user->id]) }}" class="btn btn-outline-primary">
