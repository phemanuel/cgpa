            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <h4>Edit Course | <a href="{{route('course-setup')}}">Course List</a></h4>
                  </div>
                  @if(session('success'))
                  ...
                  @elseif(session('error'))
                    ...
                    @endif	
                  <div class="card-body">
                  <form action="{{route('course-edit.action', ['id' => $course->id])}}" method="POST">
                    @csrf  
                    @method('PUT') 
                    ...
                    <div class="form-group"> 
                        ...
                        <select name="acadSession" class="form-control">
                            @php
                                ...
                                $currentYear = date('Y');
                                $startYear = 2018; // Starting year for the session
                            @endphp
                            <option value="{{$course->session1}}">{{$course->session1}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="courseTitle" class="form-control" value="{{$course->course_title}}">
                    </div>
                    @error('courseTitle')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="courseCode" class="form-control" value="{{$course->course_code}}">
                    </div>
                    @error('courseCode')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="courseUnit" class="form-control" value="{{$course->course_unit}}">
                    </div>
                    @error('courseUnit')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
